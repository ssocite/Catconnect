...
g.ap_geocode_value_description__c like '%New York%'
--or g.ap_geocode_value_description__c like '%San Francisco%'
---or g.ap_geocode_value_description__c like '%Los Angeles%'
---or g.ap_geocode_value_description__c like '%South Florida%'
---or g.ap_geocode_value_description__c like '%Charlotte%')
...
select distinct
       ...
       asia.involvement_name as asia_executive,
