...
crf as (select c.constituent_donor_id,
c.constituent_last_contact_report_record_id,
c.constituent_last_contact_report_date,
c.constituent_last_contact_primary_relationship_manager_date,
c.constituent_last_contact_report_author,
c.constituent_last_contact_report_purpose,
c.constituent_last_contact_report_method,
c.constituent_visit_count,
c.constituent_visit_last_year_count,
c.constituent_last_visit_date
from
DM_ALUMNI.DIM_CONSTITUENT C)
