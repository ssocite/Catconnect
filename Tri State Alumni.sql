...
and (geocode.ap_geocode_value_description__c like '%New York%'))
...
--- KSM Alumi in New York Geocode or All of CT and NJ

and ((fa.ucinn_ascendv2__donor_id__c is not null)

or (e.preferred_address_state = 'CT'

or e.preferred_address_state = 'NJ'))

and d.first_ksm_year IN ('2001')
